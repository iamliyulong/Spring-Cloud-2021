...
import com.lyl.springcloud.alibaba.dao.OrderDao;
import com.lyl.springcloud.alibaba.domain.Order;
import com.lyl.springcloud.alibaba.service.AccountService;
...
public class OrderServiceImpl implements OrderService {
     ...
     */
    @Override
    @GlobalTransactional(name = "lyl-create-order", rollbackFor = Exception.class)
